...
- Use a **dedicated lightweight endpoint** (e.g., `/health`) instead of hitting business logic routes.  
- Configure **reasonable intervals and timeouts** (too frequent checks may overload the service).  
